...
><small>更新于：2023-12-21 19:40</small>
...
[Demo文件](/data/2023/simple_demo.pdf)，下载本地后通过 SublimeText 类似的软件工具打开文件查看内部文件结构内容。下面通过一张图讲解一下文件的逻辑结构。  

![DemoLogicalStructure](/img/article-img/2023/1218_3.png)  
