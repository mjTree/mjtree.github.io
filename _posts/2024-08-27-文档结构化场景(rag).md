...
><small>更新于：2024-08-27 21:00</small>
...
<img src="C:/D/zzz/mjtree.github.io/img/article-img/2024/08/0827_1.png" alt="RAG" width="50%" height="50%">  

处理客户的文档数据时，大致分为了文档结构化，文档内容分块、向量化、入库。文档结构化这个很早就有篇章介绍了，这里我们不再赘述，下面我们讲解一下后面的三个步骤。  
...
<img src="C:/D/zzz/mjtree.github.io/img/article-img/2024/08/0827_2.png" alt="文本向量化" width="70%" height="70%">  
```python
