...
<img src="C:/D/zzz/mjtree.github.io/img/article-img/2024/06/0609_1.png" alt="first" width="15%" height="15%">  

先将矩阵中的“位移变换矩阵”分解出来，如下图所示：  
<img src="C:/D/zzz/mjtree.github.io/img/article-img/2024/06/0609_2.png" alt="second" width="45%" height="45%">  

接着由于“缩放变换矩阵”和“旋转变化矩阵”的 e, f 参数都为 0，可以只算左上角的 2X2 矩阵，即需要分解成旋转和缩放矩阵，而这两个矩阵的乘积如下:  
<img src="C:/D/zzz/mjtree.github.io/img/article-img/2024/06/0609_3.png" alt="third" width="35%" height="35%">  

快速计算旋转的角度 θ，可以忽略缩放变换矩阵的干扰。  
<img src="C:/D/zzz/mjtree.github.io/img/article-img/2024/06/0609_4.png" alt="fourth" width="20%" height="20%">  
